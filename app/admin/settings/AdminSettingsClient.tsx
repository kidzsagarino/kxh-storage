    ...
    () =>
      ({
        ...
        storageDiscounts: [
          ...
          { months: 2, percentOff: 0 },
          { months: 3, percentOff: 5 },
          { months: 4, percentOff: 5 },
          { months: 5, percentOff: 5 },
          { months: 6, percentOff: 15 },
          { months: 7, percentOff: 15 },
          { months: 8, percentOff: 15 },
          { months: 9, percentOff: 15 },
          { months: 10, percentOff: 15 },
          { months: 11, percentOff: 15 },
          { months: 12, percentOff: 20 },
        ],
