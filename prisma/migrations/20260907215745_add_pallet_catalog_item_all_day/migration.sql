/*
  ...
  - The values [RETURN] on the enum `TimeSlotKey` will be removed. If these variants are still used in the database, this will fail.

*/
-- AlterEnum
BEGIN;
CREATE TYPE "TimeSlotKey_new" AS ENUM ('MORNING', 'AFTERNOON', 'EVENING', 'ALL_DAY');
